-- Migration: sponsored_impressions_tables
-- Created at: 1756042332

-- Sponsored Impressions System for WiseTrip - Core Tables
...
CREATE TABLE IF NOT EXISTS sponsored_impressions (
    ...
    displayed_date DATE GENERATED ALWAYS AS (DATE(displayed_at)) STORED,
...
CREATE INDEX IF NOT EXISTS idx_sponsored_impressions_advertiser_date 
    ON sponsored_impressions(advertiser_id, displayed_date);
CREATE INDEX IF NOT EXISTS idx_sponsored_impressions_business_date 
    ON sponsored_impressions(business_id, displayed_date);
