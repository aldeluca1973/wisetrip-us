-- Migration: sponsored_impressions_basic
-- Created at: 1756042347

-- Sponsored Impressions System for WiseTrip - Basic Tables
...
CREATE TABLE IF NOT EXISTS sponsored_impressions (
    ...
    cost_per_impression DECIMAL(10,4) DEFAULT 0.05,
    cost_per_click DECIMAL(10,4) DEFAULT 0.25,
    daily_budget_remaining DECIMAL(10,2),
    campaign_id VARCHAR(255),
    position_rank INTEGER DEFAULT 1,
...
CREATE INDEX idx_sponsored_impressions_advertiser ON sponsored_impressions(advertiser_id);
CREATE INDEX idx_sponsored_impressions_business ON sponsored_impressions(business_id);
CREATE INDEX idx_sponsored_impressions_displayed_at ON sponsored_impressions(displayed_at);
...
CREATE INDEX idx_sponsored_campaigns_advertiser ON sponsored_campaigns(advertiser_id);
...
CREATE INDEX idx_sponsored_daily_caps_campaign ON sponsored_daily_caps(campaign_id);
CREATE INDEX idx_sponsored_daily_caps_date ON sponsored_daily_caps(cap_date);;